...
def extract_value(market_name="okcoinCNY"):
    r=requests.get("http://bitcoincharts.com/markets/"+market_name+".html",headers={'User-Agent':'Mozilla/5.0'})
    c=r.content
...
options=[("okcoinCNY","Okcoin CNY"),
         ("btcnCNY","BTCN China"),
         ("coinsbankEUR", "CoinsBank (EUR)"),
         ("getbtcUSD", "GetBTC (USD)"),
         ]
